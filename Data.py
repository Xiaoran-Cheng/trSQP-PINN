...
#             ui = reaction.solution(reaction.u0(X_star[:,0]), X_star[:,1]).reshape(1,N) + random.uniform(random.PRNGKey(key_num), \
#                                                     shape=(1,N), minval=-self.noise_level, maxval=self.noise_level)
#             xi = X_star[:,0].reshape(1,N)
#             ti = X_star[:,1].reshape(1,N)
...
#                                                     shape=(N,), minval=-self.noise_level, maxval=self.noise_level)
#             ui = ui.reshape(1,N)
#             X_star = X_star[index,:]
#             xi = X_star[:,0].reshape(1,N)
#             ti = X_star[:,1].reshape(1,N)
